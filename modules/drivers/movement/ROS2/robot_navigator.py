...
class BasicNavigator(Node):
    ...
    def __init__(self, namespace='big'):
        ...
        self.nav_through_poses_client = ActionClient(self,
                                                     ...
                                                     f'{namespace}/navigate_through_poses')
        self.nav_to_pose_client = ActionClient(self, NavigateToPose, f'{namespace}/navigate_to_pose')
        self.follow_waypoints_client = ActionClient(self, FollowWaypoints, f'{namespace}/follow_waypoints')
        self.follow_path_client = ActionClient(self, FollowPath, f'{namespace}/follow_path')
        self.compute_path_to_pose_client = ActionClient(self, ComputePathToPose,
                                                        f'{namespace}/compute_path_to_pose')
        self.compute_path_through_poses_client = ActionClient(self, ComputePathThroughPoses,
                                                              f'{namespace}/compute_path_through_poses')
        self.smoother_client = ActionClient(self, SmoothPath, f'{namespace}/smooth_path')
        self.spin_client = ActionClient(self, Spin, 'spin')
        self.backup_client = ActionClient(self, BackUp, 'backup')
        self.assisted_teleop_client = ActionClient(self, AssistedTeleop, f'{namespace}/assisted_teleop')
        self.localization_pose_sub = None #self.create_subscription(PoseWithCovarianceStamped,
                                           #                   'amcl_pose',
